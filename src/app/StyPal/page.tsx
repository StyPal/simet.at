    ...
    return (
        <div
            ...
            <header className="flex items-center justify-center w-full gap-4">
                <Link className="text-sm sm:text-lg leading-tight text-colors-purple flex-1 text-center sm:text-left"
                      href="/MoGame11">
                    MoGame11
                </Link>

                <Link className="font-bold text-xl sm:text-3xl leading-tight text-colors-blue text-center flex-none"
                      href="/">
                    MORITZ SIMET
                </Link>

                <Link className="text-sm sm:text-lg leading-tight text-colors-red flex-1 text-center sm:text-right"
                      href="/StyPal">
                    StyPal
                </Link>
            </header>
